...
$script:Text = @{
    en = @{
        ...
        Subtitle = 'Lightweight Setup & Optimization Assistant'
        Home = 'Home'
        Scan = 'Device Scan'
    ...
    ar = @{
        Title = 'Windows 11 Gaming Optimizer'
        Subtitle = 'مساعد إعداد وتحسين خفيف'
        Home = 'الرئيسية'
        Scan = 'فحص الجهاز'
        Optimize = 'التحسين'
...
$header = New-Label (T 'Title') 28 22 780 40 20
$content.Controls.Add($header)

$subHeader = New-Label (T 'Subtitle') 30 62 780 28 10
...
function Add-SectionPanel {
    ...
    $panel.Size = New-Object System.Drawing.Size(800,$H)
...
function Show-Scan {
    ...
    $box.Size = New-Object System.Drawing.Size(800,360)
    $box.Multiline = $true
    $box.ReadOnly = $true
...
function Show-Optimize {
    ...
    $scroll.Size = New-Object System.Drawing.Size(800,430)
...
function Show-Results {
    ...
    $grid.Size = New-Object System.Drawing.Size(800,390)
